...
I am currently a Ph.D. student in the Golisano College of Computing and Information Sciences (GCCIS) at Rochester Institute of Technology (RIT), where I am fortunate to be advised by [Professor Lingwei Chen](https://lgchen.org/). Before that, I obtained my Bachelor's degree in CS from the Advanced Program in Computer Science at Ho Chi Minh City University of Science, Vietnam, one of the top undergraduate programs in Vietnam, where I was fortunate to be advised by [Professor Minh-Triet Tran](https://scholar.google.com/citations?hl=en&user=lt2ATkkAAAAJ&view_op=list_works&authuser=2&sortby=pubdate}).
